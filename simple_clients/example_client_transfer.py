...
def arg_parse():
    ...
    parser.add_argument(
        "--file", help="Filename for awesome text", default="awesome.txt"
    )
...
if __name__ == "__main__":
    ...
    print(
        "https://app.globus.org/file-manager?destination_id="
        + local_endpoint_id
        + "&destination_path=%2F~%2F&origin_id=ef4203ca-6510-466c-9bff-a5d2cc316673&origin_path=%2Fdemo%2Fanimals%2F"
    )
    print("###")
    print("")
